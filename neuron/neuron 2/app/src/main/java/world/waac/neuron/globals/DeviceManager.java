...
public class DeviceManager {
    ...
    private DeviceManager() {
        ...
        myDevice.setStatus(TransferConstants.DEVICE_DISCONNECTED);
    ...
    public void addDevice(WifiP2pDevice wifiP2pDevice) {
        ...
        deviceDTO.setPort(-1);
        deviceDTO.setStatus(TransferConstants.DEVICE_DISCONNECTED);
    ...
    public void setAllDisconnected() {
        for (DeviceDTO device : deviceDTOList) {
            device.setStatus(TransferConstants.DEVICE_DISCONNECTED);
        }
    }
