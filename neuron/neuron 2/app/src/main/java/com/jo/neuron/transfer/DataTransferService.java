...
public class DataTransferService extends IntentService {
    ...
    public static final String ACTION_SEND_FILE = "com.jo.neuron.SEND_FILE";
    public static final String ACTION_SEND_DATA = "com.jo.neuron.SEND_DATA";
...
//    public static final int CLIENT_SERVER = 8999;
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        Log.d("eeee", "data transfer service");
        ...
        if (intent.getAction().equals(ACTION_SEND_FILE)) {
            ...
            Log.d("eeee", "data transfer service send data" + host + port);
