package com.jo.neuron.activities;
...
import com.jo.neuron.fragments.FilesFragment;
import com.jo.neuron.fragments.HomeFragment;
import com.jo.neuron.fragments.SettingsFragment;
import com.jo.neuron.globals.AppController;
import com.jo.neuron.globals.ConnectionUtils;
import com.jo.neuron.globals.GlobalConstants;
import com.jo.neuron.globals.NotificationToast;
...
import com.jo.neuron.receivers.WiFiDirectBroadcastReceiver;
import com.jo.neuron.transfer.DataHandler;
import com.jo.neuron.transfer.DataSender;
import com.jo.neuron.transfer.TransferConstants;
...
import static com.jo.neuron.activities.SearchResultActivity.KEY_FILE_PATHS;
import static com.jo.neuron.activities.SearchResultActivity.KEY_SELECTED_DEVICE_TO_SEARCH_RESULT;
import static com.jo.neuron.transfer.DataHandler.KEY_SELECTED_DEVICE;
import static com.jo.neuron.transfer.DataHandler.SELECTED_DEVICE_CONFIRMED;
import static com.jo.neuron.transfer.TransferConstants.DEVICE_CONNECTED;
import static com.jo.neuron.transfer.TransferConstants.DEVICE_CONNECTING;
...
//        connListener.tearDown();
    ...
    public void gotoSearchResultActivity(List<String> filePaths, DeviceDTO selectedDevice) {
        ...
        intent.putExtra(KEY_FILE_PATHS, (Serializable) filePaths);
        intent.putExtra(KEY_SELECTED_DEVICE_TO_SEARCH_RESULT, selectedDevice);
